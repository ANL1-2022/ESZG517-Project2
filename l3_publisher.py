...
BROKER_URL  = "c8856ca974fd4708b84480345616bea7.s1.eu.hivemq.cloud"  # Your HiveMQ cluster URL
BROKER_PORT = 8883                                   # TODO-4  # 8883: secure MQTT port (TLS)
USERNAME    = "Akash"                                # Your HiveMQ username
PASSWORD    = "World@1cup"                           # Your HiveMQ password
YOUR_USN    = "2025CA01039"                          # e.g. "2023HT12345"
...
def publish_door(client, door_open):
    ...
    client.publish(TOPIC_DOOR, payload, qos=0, retain=False)
...
def publish_window(client, window_open):
    ...
    client.publish(TOPIC_WINDOW, payload, qos=0, retain=False)
